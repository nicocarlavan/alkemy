...
class ListOut extends Component {
    ...
    componentDidMount() {
        fetch('/api/records/listout')
            .then(response => {
                return response.json()
            })
            .then(records => {
                this.setState({
                    listOut: records.data.recordsOut,
                    ...
                    <div id="content">
                        ...
                        <div className="card shadow mb-4 table-responsive">
                            <div className="card-header py-3 ">
                                <h5 className="m-0 font-weight-bold text-gray-800">Listado de Egresos</h5>
                                <br></br>
